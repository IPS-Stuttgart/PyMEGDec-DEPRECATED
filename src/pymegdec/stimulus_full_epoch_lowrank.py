...
def _select_candidate(inner_rows, candidate_configs):
    ...
    for rank, row in enumerate(ranked, start=1):
        ...
        temporal_feature_mode = getattr(config, "temporal_feature_mode", row.get("selected_temporal_feature_mode", ""))
        row["selected_ensemble_temporal_feature_mode_counts"] = _format_counter(Counter((str(temporal_feature_mode),)))
