...
ENSEMBLE_SCORE_NORMALIZATION_MODES = (
    ...
    "rank_top2_vote_balanced_quota",
    "rank_top3_vote_balanced_quota",
    ...
    "rank_top2_vote_guarded_balanced_quota",
    "rank_top3_vote_guarded_balanced_quota",
...
INNER_CONFUSION_ENSEMBLE_SCORE_NORMALIZATION_BASES = {
    ...
    "rank_margin_blend_inner_confusion_margin_soft_guarded": "rank_margin_blend",
}
INNER_BALANCED_CONFUSION_ENSEMBLE_SCORE_NORMALIZATION_BASES = {
    ...
    "rank_softmax_inner_balanced_confusion_soft_guarded": "rank_softmax",
    ...
    *,
    ...
    if include_predictions:
        prediction_rows = _prediction_rows(
            ...
            class_scores=ensemble_probabilities,
            score_classes=class_order,
        )
...
def _prediction_rows(
    ...
    *,
    ...
    train_window = _centered_window(config.window_center, config.window_size)
    rows = []
    for row_index, (true_label, predicted_label, true_label_rank) in enumerate(zip(test_labels, predictions, true_label_ranks)):
        ...
        row = {
            ...
            "trial": int(row_index),
            "test_trial_index": int(row_index),
            "test_trial_number": int(row_index + 1),
