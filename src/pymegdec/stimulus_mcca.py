"""Public facade for NeuRepTrace-backed M-CCA stimulus decoding."""
...
from neureptrace.decoding.mcca import (
    ...
    fit_class_mcca as _nrt_fit_class_mcca,
)
from neureptrace.decoding.mcca_target import (
    class_alignment_matrix as _nrt_class_alignment_matrix,
    fit_target_mcca_projection as _nrt_fit_target_mcca_projection,
)
...
_impl.fit_class_mcca = _nrt_fit_class_mcca
_impl.class_alignment_matrix = _nrt_class_alignment_matrix
_impl.fit_target_mcca_projection = _nrt_fit_target_mcca_projection
